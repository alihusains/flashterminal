...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-15 (commit a289039). Confidence: 95%.
...
**Language:** rust | **Files:** 10 | **Public symbols:** 443 / 984
Covers command.rs, engine.rs, events.rs…
- `apps/cli/src` — apps/cli/src · apps/desktop/src
**Language:** rust | **Files:** 2 | **Public symbols:** 0 / 223
Covers the main.rs entry points in…
- `crates/terminal-session/src` — crates/terminal-session/src
**Language:** rust | **Files:** 16 | **Public symbols:** 1484 / 2779
Covers adaptive.rs, agent.rs…
- `benchmarks/benches` — benchmarks/benches · benchmarks/src · benchmarks/src/bin
**Language:** rust | **Files:** 14 | **Public symbols:** 0 / 239
Covers…
- `crates/terminal-session/src/adapters` — crates/terminal-session/src/adapters
**Language:** rust | **Files:** 7 | **Public symbols:** 36 / 117
Covers claude.rs, codex.rs, fake.rs…
